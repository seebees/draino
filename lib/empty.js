        ...
        function empty(op, toEmpty) {
            ...
            case 'undefinedtrue':
                accumulator = function (chunk) {
                    ...
                    toEmpty._accumulationDepth += 1;
                    if (op.plow && toEmpty._accumulationDepth >= op.plow) {
                        _tell();
                        toEmpty._accumulationDepth = 0;
                    }
                };
                break;
            case 'functiontrue':
            ...
            if (toEmpty instanceof EventEmitter) {
                ...
                toEmpty.forEach(empty.bind(null, op));
            }
        }
